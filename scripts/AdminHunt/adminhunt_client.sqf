...
_start = player addaction ["<t color='#00FF00'>Start admin hunt</t><t color='#30FF00'> - remember to gear up with valid loot - </t>",{starthunt = true;},"",-93,false,false,"",""]; 
...
Admin %1 activated the Hunt-an-admin mission<br/>
Check your map to see where he is, kill him!!!</t>",_nameadmin];
	...
	_markertext  = format ["Adminhunt: %1",_nameadmin];
...
[_markeradmin] spawn {
	...
	while {alive player} do {
		if (reinforce) then {
			...
			_hint = format ["<t align='center' size='2.0' color='#f29420'>Mission<br/>Admin Hunt Reinforcements!</t><br/>
<t align='left' size='1.25' color='#ffff00'>______________<br/><br/>
Admin %1 feels threatened and got reinforcements<br/>
...
<t align='left' size='1.25' color='#ffff00'>______________<br/><br/>
The admin chickened out and stopped the mission. %1 is a fucking pussy!</t>",_nameadmin];
...
<t align='left' size='1.25' color='#ffff00'>______________<br/><br/>
Admin %1 is dead, long live the Admin!<br/>
but be careful, his bodyguards might still be in the area..</t>",_nameadmin];
					...
					_hint = format ["<t align='center' size='2.0' color='#6bab3a'>Mission success</t><br/>
<t align='left' size='1.25' color='#ffff00'>______________<br/><br/>
Admin %1 is dead, long live the Admin!</t>",_nameadmin];
